...
class WattingCofirm extends StatefulWidget {
  const WattingCofirm({Key? key}) : super(key: key);

  @override
  State<WattingCofirm> createState() => _WattingCofirmState();
}

class _WattingCofirmState extends State<WattingCofirm> {
  ...
  void initState() {
    ...
    invoices.getInvoiceByAccountAndStatus(context, userr.id, 1);
  }
  @override
